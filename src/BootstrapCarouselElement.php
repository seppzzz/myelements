...
class BootstrapCarouselElement extends BaseElement
{
	...
	public function getCMSFields()
    {
		...
		$fields->insertAfter( TextField::create('SliderInterval','SliderInterval ( millisec e.g.: 4000 )'), 'PaddingBottom');
		$fields->insertAfter( TextField::create('Transition','Transition ( sec e.g.: 1.4 )'), 'SliderInterval');
	...
	public function onBeforeWrite() 
	{
		...
		//$this->SliderInterval = $this->convertSeconds($this->SliderInterval);
